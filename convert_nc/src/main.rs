...
fn hashmap_to_array<K, V>(map: HashMap<K, V>, keys: &[K]) -> Vec<V>
where
    K: Eq + Hash + Clone,
    V: Clone,
{
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    //let file = netcdf::open("data/D1901094_109.nc")?;
    let file = netcdf::open("data/R13857_068.nc")?;
